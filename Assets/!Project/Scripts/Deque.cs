...
namespace System.Collections.Generic
{
    ...
    public class Deque<T> : IList<T>
    {
        ...
        /// <summary>
        /// Alias to AddBack for drop-in compatibility with Queue
        /// </summary>
        /// <param name="item">The item to add.</param>
        ...
        /// <summary>
        /// Alias to RemoveFront for drop-in compatibility with Queue
        /// </summary>
        /// <returns>The item at the front of the Deque.</returns>
        public void Dequeue()
        {
        ...
        /// <summary>
        /// Returns front of the Deque without modification of Deque.
        /// </summary>
        /// <returns>The item at the front of the Deque.</returns>
        public T PeekFront()
        {
        ...
        /// <summary>
        /// Alias to PeekFront for drop-in compatibility with Queue
        /// </summary>
        /// <returns>The item at the front of the Deque.</returns>
        public T Peek()
        {
        ...
        /// <summary>
        /// Returns back of the Deque without modification of Deque.
        /// </summary>
        ...
        public T PeekBack()
        {
            ...
            int endIndex = toBufferIndex(this.Count - 1);
            T result = buffer[endIndex];
